...
let refridata = JSON.parse(localStorage.getItem("washing"))
...
function showdata(sona)
{
 ...
 if(elem.returns==undefined ||elem.price.extracted==undefined ||elem.shipping==undefined)
 {
   return;
 }
//         console.log(elem.title)
        ...
        div5.setAttribute("class", "priceText")
